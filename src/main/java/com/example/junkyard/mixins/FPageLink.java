...
public class FPageLink {
    ...
    void beginRender(final MarkupWriter writer) {
        ...
        String bootstrapClassVariables = "";
        String buttonSize = "";
        ...
        if (displayAs.equals("button")) {
            ...
            if( typeOfButton != null){
                ...
                if (typeOfButton.equals("default")) {
                    ...
                    throw new BusinessException("Illegal parameter value provided to TYPE of FPageLink");
                }
            }
            ...
            if( disabled != null){
                ...
                if (disabled.equals("true")) {
                    ...
                    throw new BusinessException("Illegal parameter value provided to DISABLED of FPageLink");
                }
            }
            ...
            if( sizeOfButton != null){
                ...
                if (sizeOfButton.equals("large")) {
                    ...
                    throw new BusinessException("Illegal parameter value provided to SIZE of FPageLink");
                }
            }
            ...
            if (!StringUtils.isNotBlank(icon)) {
                ...
                throw new BusinessException("Illegal parameter value provided to icon of FPageLink");
            }
            ...
            if (!StringUtils.isNotBlank(iconColor) || iconColor.equals("white")) {
                ...
                throw new BusinessException("Illegal parameter value provided to iconColor of FPageLink");
            }            
        ...
        final String addClasses = bootstrapClassVariables;
        final String iconClass = icon + " " + iconColor;

        Runnable command = new Runnable() {
            public void run() {
                pageLinkElement.forceAttributes("class", addClasses  );
                if (displayAs.equals("button")) {
